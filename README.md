...
- All of this needs to run in real time, which is just slightly beyond the limit of what I think pure python can do.
...
- #### Measurement + Point Registration
  ...
  - Scanning the points looks like this: ![this](assets/readme/measure.gif)
